        ...
        <div class="site-wrapper">
            ...
            <div class="row page-title">
                <div class="container clear-padding text-center flight-title">
                    <h1><?php echo $tour_details->tour_title; ?></h1>
                </div>
            </div>
            <div class="row flex-row">
                <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="col-lg-12 col-md-12 col-sm-12" style="margin-top:70px;margin-bottom:30px;">
                            <img src="<?php echo base_url() . $tour_details->tour_additional_image_0; ?>" class="img-responsive">
                        </div>                        
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h2 style="text-align:center;" class="color-green"><?php echo $tour_details->tour_subtitle; ?></h2><br/>
                            <p style="text-align:justify;font-family:arial;" class="color-text">
                                <?php echo $tour_details->tour_description; ?>
                            </p>
                            <div style="width:100%;margin-top:60px;" class="tour-gallery fix">
                                <div class="col-lg-4 col-md-4 col-sm-4 " style="padding:0px;">
                                    <img src="<?php echo base_url() . $tour_details->tour_additional_image_1; ?>" class="img-responsive" style="height: 170px; width: 230px;">
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4" style="padding:0px;">
                                    <img src="<?php echo base_url() . $tour_details->tour_additional_image_2; ?>" class="img-responsive" style="height: 170px; width: 230px;">
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4" style="padding:0px;">
                                    <img src="<?php echo base_url() . $tour_details->tour_additional_image_3; ?>" class="img-responsive" style="height: 170px; width: 230px;">
                                </div>
                            </div>
                            &nbsp;
                            <div style="width:100%;" class="tour-gallery fix">
                                <div class="col-lg-4 col-md-4 col-sm-4 " style="padding:0px;">
                                    <img src="<?php echo base_url() . $tour_details->tour_additional_image_4; ?>" class="img-responsive" style="height: 170px; width: 230px;">
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4" style="padding:0px;">
                                    <img src="<?php echo base_url() . $tour_details->tour_additional_image_5; ?>" class="img-responsive" style="height: 170px; width: 230px;">
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4" style="padding:0px;">
                                    <img src="<?php echo base_url() . $tour_details->tour_additional_image_6; ?>" class="img-responsive" style="height: 170px; width: 230px;">
                                </div>
                            </div>
                            <div  style="margin-top:45px;">
                                <img src="<?php echo base_url(); ?>assets/public/images/icon.png" class="img-responsive fix" style="float:left;">
                                <h2 style="padding-top:10px;" class="color-green">
                                    &nbsp;&nbsp;ITINERARY
                                </h2>
                            </div>
                            <p style="padding-top:30px;" class="color-text">
                                <?php echo $tour_details->tour_itinerary; ?>
                            </p>
                            <div style="margin-top:45px;">
                               <img src="<?php echo base_url(); ?>assets/public/images/icon.png" class="img-responsive fix" style="float:left;">
                                <h2 style="padding-top:10px;" class="color-green">
                            ...
                            <br/>
                            <p class="color-text">
                                <?php echo $tour_details->tour_pricing; ?>
                            </p>
                            <br/>
                            <a href="" class="tours-know-more fix">BOOK NOW</a>
                            ...
                            <br/>
                            <ul style="padding-left:15px;margin-bottom:40px;" class="color-text">
                                <?php echo $tour_details->tour_remarks; ?>
                            </ul>
                        </div>
                    </div>
                </div>
