                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        foreach ($all_tour as $v_tour) {
                            ?>
                            <div class="col-lg-12 col-md-12 col-sm-12 ture-content">
                                <div class="col-lg-5 col-md-5 col-sm-5 ">
                                    <img src="<?php echo base_url() . $v_tour->tour_additional_image_0; ?>" class="img-responsive tour">
                                </div>
                                <div class="col-lg-7 col-md-7 col-sm-7 ">
                                    <h3 class="color-green"><span><?php echo $v_tour->tour_title; ?></span></h3>
                                    <p style="margin-bottom: 6%;">
                                        <?php echo $v_tour->tour_summary; ?><br/><br/>
                                        <span class="color-orange"><?php echo $v_tour->tour_price; ?></span> 
                                    </p>
                                    <a href="<?php echo base_url(); ?>evis_travel/tour_details/<?php echo $v_tour->tour_id; ?>" class="tours-know-more">KNOW MORE</a>
                                </div>
                            </div>
                            <?php
                        }
