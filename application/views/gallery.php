...
<html class="load-full-screen">
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/public/css/magnific-popup.css" rel="stylesheet" media="screen">
                        ...
                        foreach ($gallery as $v_gallery) {
                            ...
                            <div class="col-md-3 col-sm-4">
                                <div class="image-wrapper">
                                    <img src="<?php echo base_url() . $v_gallery->gallery; ?>" style="height: 176px; width: 262px;">
                                    <div class="img-caption">
                                        <div class="link">
                                            <a href="<?php echo base_url() . $v_gallery->gallery; ?>" target="_blank">
