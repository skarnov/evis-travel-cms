...
<html class="load-full-screen">
    ...
    <body class="load-full-screen">
        ...
        <div class="site-wrapper">
            ...
            <div class="row flex-row">
                <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="col-lg-12 col-md-12 blog-by">
                            <img src="<?php echo base_url() . $blog_details->blog_image; ?>" class="img-responsive">
                            <h6><?php echo $blog_details->blog_time; ?> &nbsp; by <?php echo $blog_details->admin_name; ?></h6>
                        </div>
                        <div class="col-lg-12 col-md-12 blog-title">
                            <h2><?php echo $blog_details->blog_title; ?></h2>
                        </div>
                        <div class="col-lg-12 col-md-12 blog-body">
                            <p>
                                <?php echo $blog_details->blog; ?>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section>
                <div class="row">
                    <div class="response container-fluid ">
                        <div class="col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2">
                            ...
                            if (!$username) {
                                ...
                                <div class="comment-box">
                                    <div class="leave-comment">
                                        <div class="text-center">
                                            <button type="submit" data-toggle="modal" data-target="#login" class="btn btn-default submit-review">For Commenting You Have To Login</button>
                                        </div>
                                    </div>
                                </div>
                                <?php
                                ...
                                ?>
                                <div class="leave-comment">
                                    <form action="<?php echo base_url(); ?>evis_travel/save_comment" method="POST">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="write-response" >
                                                <span class="fa fa-comment-o text-muted">&nbsp; Write a response...</span>
                                            </div>
                                        </div>
                                        <br/><br/><br/><br/>
                                        <div class="col-md-12">
                                            <textarea class="form-control" rows="5" id="comment" name="comment" style="height:200px;"></textarea>
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                foreach ($all_comment as $v_comment) {
                                    ?>
                                    <div class="previus-response">
                                        <div class="col-lg-12 col-md-12">
                                            <img src="<?php echo base_url() . $v_comment->user_image; ?>" class="col-xs-1 clear-padding img-responsive">
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <h5 style="color:#ed6c22"><?php echo $v_comment->username; ?></h5>
                                            <h5><?php echo $v_comment->comment; ?></h5>
                                        </div>
                                    </div>
                                    <?php
                                }
