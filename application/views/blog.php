        ...
        <div class="site-wrapper">
            ...
            <div class="row page-title">
                <div class="container clear-padding text-center flight-title">
                    <h3>Blog</h3>
                    <h4 class="thank">Latest Blog And Updates</h4>
                </div>
            </div>
            <section>
                <div class="row">
                    <div class="container clear-padding">
                        <h3 style="color:green">
                            <?php
                            $msg = $this->session->userdata('comment');
                            if (isset($msg)) {
                                echo $msg;
                        ...
                        <div>
                            <div class="col-md-8 col-sm-8">
                                <?php
                                foreach ($new_blog as $v_blog) {
                                    ?>
                                    <div class="post-wrapper">
                                        <img src="<?php echo base_url() . $v_blog->blog_image; ?>" style="margin-left: 30%;">
                                        <div class="post-body">
                                        ...
                                        <div class="post-footer">
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <h5><?php echo $v_blog->blog_time; ?> / By <span style="color: #ed6c22"><?php echo $v_blog->admin_name; ?></span></h5>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-6 read-more clear-padding">
                                                <a href="<?php echo base_url(); ?>evis_travel/blog_details/<?php echo $v_blog->blog_id; ?>" class="pull-right">READ MORE</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                            ...
                            <div class="col-md-4 col-sm-4 booking-sidebar">
                                ...
                                <div class="sidebar-item recent-post">
                                    ...
                                    <div class="sidebar-body">
                                        <?php
                                        foreach ($popular_post as $v_blog) {
                                            ?>
                                            <div class="wrapper">
                                                <div class="col-md-3 col-sm-3 col-xs-3 clear-padding">
                                                    <img src="<?php echo base_url() . $v_blog->blog_image; ?>" alt="Blog Image" style="height: 60px; width: 80px;">
                                                </div>
                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                    <a href="<?php echo base_url(); ?>evis_travel/blog_details/<?php echo $v_blog->blog_id; ?>"><?php echo $v_blog->blog_title; ?></a>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <?php
