            ...
            <div class="row our-team">
                <div class="container clear-padding">
                    <div class="section-title text-center">
                        <h2>Failed !</h2>
                        <h4>Your User Name Or Password Invalid</h4>
                        <a href="#" data-toggle="modal" data-target="#login" class="transition-effect btn btn-success">
                            <i class="fa fa-user"></i> Try Again
                        </a>
                    </div>
                </div>
            </div>
